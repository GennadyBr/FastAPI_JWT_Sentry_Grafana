...
from tests.test_handlers.test_data import user_data_for_deletion
from tests.test_handlers.test_data import user_data_superadmin
...
async def test_delete_user_not_found(client, create_user_in_database):
    ...
    resp = client.delete(
        ...
        headers=create_test_auth_headers_for_user(user_data_superadmin["email"]),
    )
